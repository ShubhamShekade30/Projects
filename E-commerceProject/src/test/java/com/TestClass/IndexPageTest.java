...
public class IndexPageTest extends Baseclass {
     ...
     public void validateSignup() throws InterruptedException {
         ...
         hp.signUp("Santhu", "Santhusri@1994");
     ...
     public void validateLogin() throws InterruptedException {
         ...
         hp.login("Santhu", "Santhusri@1994");
     ...
     public void OrderDetails() throws InterruptedException {
         ...
         IndexPage indexPage = new IndexPage(driver);
         indexPage.OrderDetails("Santhosh", "India", "Hyderabad", "500044", "Dec", "2024");
         indexPage.logout();
 ...
 public void captureScreenshotAfterTest(ITestResult result) {
     try {
         ...
         String baseDir = "C:\\Users\\WINDOWS\\eclipse-workspace\\E-commerceProject\\Screenshots.png";
